...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    StatusLine   {bg="#010101" }, -- Status line of current window
    -- StatusLineNC { bg="#000000"}, -- Status lines of not-current windows. Note: If this is equal to "StatusLine" Vim will use "^^^" in the status line of the current window.
    -- TabLine      { }, -- Tab pages line, not active tab page label
    -- TabLineFill  { }, -- Tab pages line, where there are no labels
    -- TabLineSel   { }, -- Tab pages line, active tab page label
    Title        { fg="#cb8fd9"}, -- Titles for output from ":set all", ":autocmd" etc.
    Visual       { bg="#404040"}, -- Visual mode selection
